 ...
 * @since v0.1.0
 */
class AUIFreeResponseQuestion extends AUIQuestion {
    constructor(question) {
        ...
        drawSelector.getEventManager().ELEMENT_MOUSE_CLICKED.subscribe(() => {
            if (this.typingModeIsActive) {
                ...
                if (this.element.hasChild(this.textArea.getID()))
                    this.element.removeChild(this.textArea.getID());
        ...
        textSelector.getEventManager().ELEMENT_MOUSE_CLICKED.subscribe(() => {
            if (!this.typingModeIsActive) {
                ...
                textSelector.addClasses("selected");
                if (this.element.hasChild(this.canvas.getID()))
                    this.element.removeChild(this.canvas.getID());
