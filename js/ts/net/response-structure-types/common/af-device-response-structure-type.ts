 ...
 * @since v0.1.0
 */
class AFDeviceResponseStructureType extends AFResponseObjectType {
	
	public readonly name: TSType = TSStandardType.STRING;
	
	public readonly organizationId: TSType = TSStandardType.STRING;
	
	public readonly locationId: TSType = TSStandardType.STRING;
	
	public readonly folderId: TSType = TSStandardType.STRING;
	
}

export default AFDeviceResponseStructureType;